...
import barbaraLiskov from "./src/images/barbara-liskov.jpg";
...
<List>
  <ListItem>S - Single-responsability</ListItem>
  <ListItem>O - Open-closed</ListItem>
  <ListItem>L - Liskov Substitution</ListItem>
  <ListItem>I - Interface Segregation</ListItem>
  <ListItem>D - Dependency Inversion</ListItem>
</List>
...
<Heading as="h2" mb={4} style={{ textAlign: "center" }}>
  PS: Não conheço Liskov
</Heading>

---

<Heading as="h2" mb={4} style={{ textAlign: "center" }}>
  Brincadeira, é a Barbara Liskov
</Heading>

<Image src={barbaraLiskov} style={{ width: "400px", height: "500px" }} />
